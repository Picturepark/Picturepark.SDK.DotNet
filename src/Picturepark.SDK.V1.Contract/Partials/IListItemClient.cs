...
namespace Picturepark.SDK.V1.Contract
{
	public partial interface IListItemClient
	{
		...
		/// <exception cref="ApiException">A server side error occurred.</exception>
		Task<IEnumerable<ListItem>> CreateFromObjectAsync(object content, string schemaId, CancellationToken cancellationToken = default(CancellationToken));
		...
		IEnumerable<ListItem> CreateMany(IEnumerable<ListItemCreateRequest> createRequests);
		...
		/// <exception cref="ApiException">A server side error occurred.</exception>
		/// <exception cref="PictureparkException">The business process has not been completed.</exception>
		Task<IEnumerable<ListItem>> CreateManyAsync(IEnumerable<ListItemCreateRequest> createRequests, CancellationToken cancellationToken = default(CancellationToken));
