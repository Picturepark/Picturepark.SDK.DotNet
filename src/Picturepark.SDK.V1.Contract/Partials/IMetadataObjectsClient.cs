...
namespace Picturepark.SDK.V1.Contract
{
    public partial interface IMetadataObjectsClient
    {
        ...
        MetadataObjectDetailViewItem Update(string objectId, MetadataObjectUpdateRequest updateRequest, bool resolve = false, string pattern = "", int timeout = 60000);

        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task<MetadataObjectDetailViewItem> UpdateAsync(string objectId, MetadataObjectUpdateRequest updateRequest, bool resolve = false, string pattern = "", int timeout = 60000, CancellationToken cancellationToken = default(CancellationToken));
