...
namespace Picturepark.SDK.V1.Contract.Results
{
    public class ContentBatchOperationResult : BatchOperationResult<ContentDetail>
    {
        ...
        public async Task<BatchOperationResultDetail<ContentDetail>> FetchDetail(IEnumerable<ContentResolveBehavior> resolveBehaviors = null, CancellationToken cancellationToken = default)
        {
