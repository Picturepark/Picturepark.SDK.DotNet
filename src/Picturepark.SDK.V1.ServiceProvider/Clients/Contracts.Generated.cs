...
namespace Picturepark.SDK.V1.ServiceProvider.Contract
{
    ...
    public partial interface IServiceProviderRestClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{PictureparkException}">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CustomerServiceProviderConfigurationViewItem> GetConfigurationAsync(string serviceProviderId);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{PictureparkException}">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CustomerServiceProviderConfigurationViewItem> GetConfigurationAsync(string serviceProviderId, System.Threading.CancellationToken cancellationToken);
    
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{PictureparkException}">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CustomerServiceProviderConfigurationViewItem> UpdateConfigurationAsync(string serviceProviderId, ServiceProviderConfigurationUpdateRequest configuration);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{PictureparkException}">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CustomerServiceProviderConfigurationViewItem> UpdateConfigurationAsync(string serviceProviderId, ServiceProviderConfigurationUpdateRequest configuration, System.Threading.CancellationToken cancellationToken);
