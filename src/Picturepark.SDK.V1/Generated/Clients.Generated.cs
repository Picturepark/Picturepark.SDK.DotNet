...
namespace Picturepark.SDK.V1
{
    ...
    public partial class ContentClient : ClientBase, IContentClient
    {
        ...
        public async System.Threading.Tasks.Task<ContentDetail> GetAsync(string contentId, bool resolve, System.Collections.Generic.IEnumerable<DisplayPatternType> patterns = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Append("resolve=").Append(System.Uri.EscapeDataString(ConvertToString(resolve, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (patterns != null) foreach (var item_ in patterns) { urlBuilder_.Append("patterns=").Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<FileResponse> DownloadAsync(string contentId, string outputFormatId, int? width = null, int? height = null, string range = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (height != null) urlBuilder_.Append("height=").Append(System.Uri.EscapeDataString(ConvertToString(height, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    public partial class BusinessProcessClient : ClientBase, IBusinessProcessClient
    {
        ...
        protected async System.Threading.Tasks.Task<BusinessProcessWaitResult> WaitCoreAsync(string processId, System.Collections.Generic.IEnumerable<string> states = null, System.Collections.Generic.IEnumerable<BusinessProcessLifeCycle> lifeCycleIds = null, System.TimeSpan? timeout = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (states != null) foreach (var item_ in states) { urlBuilder_.Append("states=").Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            if (lifeCycleIds != null) foreach (var item_ in lifeCycleIds) { urlBuilder_.Append("lifeCycleIds=").Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            if (timeout != null) urlBuilder_.Append("timeout=").Append(System.Uri.EscapeDataString(ConvertToString(timeout, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    public partial class PermissionClient : ClientBase, IPermissionClient
    {
        ...
        public async System.Threading.Tasks.Task<bool> HasUserRightAsync(UserRight userRight, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Replace("{userRight}", System.Uri.EscapeDataString(ConvertToString(userRight, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class TransferClient : ClientBase, ITransferClient
    {
        ...
        public async System.Threading.Tasks.Task UploadFileAsync(string transferId, string identifier, FileParameter formFile = null, string relativePath = null, long? chunkNumber = null, long? currentChunkSize = null, long? totalSize = null, long? totalChunks = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (relativePath != null) urlBuilder_.Append("relativePath=").Append(System.Uri.EscapeDataString(ConvertToString(relativePath, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (chunkNumber != null) urlBuilder_.Append("chunkNumber=").Append(System.Uri.EscapeDataString(ConvertToString(chunkNumber, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (currentChunkSize != null) urlBuilder_.Append("currentChunkSize=").Append(System.Uri.EscapeDataString(ConvertToString(currentChunkSize, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (totalSize != null) urlBuilder_.Append("totalSize=").Append(System.Uri.EscapeDataString(ConvertToString(totalSize, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (totalChunks != null) urlBuilder_.Append("totalChunks=").Append(System.Uri.EscapeDataString(ConvertToString(totalChunks, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
