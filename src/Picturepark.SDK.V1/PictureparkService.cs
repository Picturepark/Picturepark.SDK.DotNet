...
public class PictureparkService : IPictureparkService
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="PictureparkService" /> class and uses the
    ///     <see cref="IPictureparkServiceSettings.BaseUrl" /> of the <paramref name="settings" /> as Fotoware Alto server URL.
    /// </summary>
    ...
    public PictureparkService(IPictureparkServiceSettings settings, HttpClient httpClient = null)
    {
        ...
        if (settings.IntegrationName != null)
        {
            httpClient.DefaultRequestHeaders.UserAgent.Add(
                new ProductInfoHeaderValue($"({settings.IntegrationName})"));
        }
    ...
    [Obsolete(
        "Transfer API is deprecated and will be removed in future release. Please use Ingest API for new projects and consider switching existing code to use Ingest API as well.")]
