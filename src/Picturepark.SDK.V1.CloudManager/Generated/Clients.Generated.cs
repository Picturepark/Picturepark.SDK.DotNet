...
namespace Picturepark.SDK.V1.CloudManager
{
    ...
    public partial class CustomerClient : ClientBase, ICustomerClient
    {
        ...
        /// <exception cref="PictureparkValidationException">Validation exception</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<CustomerConfigurationItem> AddExternalProvidersAsync(string customerId, System.Collections.Generic.IEnumerable<ExternalProvider> addRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (customerId == null)
                throw new System.ArgumentNullException("customerId");
        ...
        public async System.Threading.Tasks.Task<EnvironmentProcess> CreateMetadataLanguageAsync(string customerAlias, CustomerMetadataLanguageCreateRequest metadataLanguageCreateRequest, System.TimeSpan? timeout = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Replace("{customerAlias}", System.Uri.EscapeDataString(ClientUtilities.ConvertToString(customerAlias, System.Globalization.CultureInfo.InvariantCulture)));
            if (timeout != null) urlBuilder_.Append("timeout=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(timeout, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "11.12.15.0 (NJsonSchema v9.10.18.0 (Newtonsoft.Json v9.0.0.0))")]
    public partial class ConfigurationClient : ClientBase, IConfigurationClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public ConfigurationClient(Picturepark.SDK.V1.CloudManager.ICloudManagerClientSettings configuration, System.Net.Http.HttpClient httpClient) : base(configuration)
        {
            _httpClient = httpClient; 
    		_settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(() => 
            {
    ...
    public partial class EnvironmentProcessClient : ClientBase, IEnvironmentProcessClient
    {
        ...
        public async System.Threading.Tasks.Task<EnvironmentProcess> GetAsync(string processId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Replace("{processId}", System.Uri.EscapeDataString(ClientUtilities.ConvertToString(processId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <exception cref="PictureparkValidationException">Validation exception</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<EnvironmentProcessWaitResult> WaitForLifecycleAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/environmentProcesses/wait");
